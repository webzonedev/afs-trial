...
<h1 class="text-gray-800"><a href="/employee/files">تحميل الملفّات  <i class="fas fa-folder-open"></i> </a> </h1>
...
<div class="row">
    ...
    <div class="col-lg-3 mb-4">
          ...
          <form  method="POST" action="{{action('Employee\EmployeeFilesController@upload_files') }}"
