...
@include('employee.header' , ['activeclass' => 'files'])
...
<h1 class="text-gray-800"> الملفّات

<span><a href="/employee/files/upload"><i class="fas fa-edit text-gray-800"></i></span>

<span>  <a href="/employee/files/delete" 
            data-toggle="modal" data-target="#deleteModal" id="{{uniqid()}}" onclick="getDeleteModal(this.id,'هل تريد الغاء جميع الملفات  {{$employee->user->firstname}} {{$employee->user->firstname}} ؟')" >
          ...
          <div class="card shadow mb-4">
            ...
            @foreach ($files as $file) 
                  ...
                  @if ($file!=null && $file->filetitle=='id_card')
                    ...
                    <a href="/employee/files/{{$file->id}}/download" class="btn btn-danger btn-user btn-block" type="submit"><i class="fas fa-download"></i> {{basename($file->filepath)}}</a>
                    &nbsp;&nbsp;
                    <a href="/employee/files/{{$file->id}}/delete" 
