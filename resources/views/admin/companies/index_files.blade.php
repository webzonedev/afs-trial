...
@include('admin.companies.header' , ['activeclass' => 'files'])
          ...
          <div class="card shadow mb-4">
            ...
            @foreach ($files as $file) 
                  ...
                  @if ($file!=null && $file->filetitle=='tasjil_sherke' && $file->category=='sijil_tijare_files')
                    ...
                    <a href="/admin/companies/{{$company->id}}/files/{{$file->id}}/download" class="btn btn-danger btn-user btn-block" type="submit"><i class="fas fa-download"></i> {{basename($file->filepath)}}</a>
                    &nbsp;&nbsp;
...
@if ($file!=null && $file->filetitle=='ize3a_tijareyye' && $file->category=='sijil_tijare_files')
  ...
  <a href="/admin/companies/{{$company->id}}/files/{{$file->id}}/download" class="btn btn-danger btn-user btn-block" type="submit"><i class="fas fa-download"></i> {{basename($file->filepath)}}</a>
  &nbsp;&nbsp;
  <a href="/admin/companies/{{$company->id}}/files/{{$file->id}}/delete" 
