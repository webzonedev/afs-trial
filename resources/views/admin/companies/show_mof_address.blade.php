    ...
    <div class="card border-left-danger shadow h-100">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1">
            <a href="#" class="myCardLink cardlink-active">عنوان الشركة لدى وزارة المالية</a> <i class="text-danger fas fa-file-invoice-dollar"></i> </div>
...
<br>
<h1 class="h3 mb-0 text-danger">عنوان الشركة لدى وزارة الماليّة - <span class="text-gray-800">شركة</span> {{$company->c_name}}</h1>
<br><br>
<div class="row">
