...
<br>
<h1 class="h3 mb-0 text-danger">العمل السابق للموظّف  <span class="text-gray-800">{{$employee->user->firstname}} {{$employee->user->lastname}}</span></h1>
<br><br>
...
<form method="POST" action="/client/companies/{{$company->id}}/employees/{{$employee->id}}/oldwork">
          @csrf
