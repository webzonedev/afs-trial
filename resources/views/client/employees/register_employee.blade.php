...
<div class="card-body">
                    <form method="POST" action="/client/companies/{company}/employees/">
                        @csrf

                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right">{{ __('الاسم') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right">{{ __('الشهرة') }}</label>
