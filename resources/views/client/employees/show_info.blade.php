...
<br>
<h1 class="h3 mb-0 text-danger">معلومات الموظّف  <span class="text-gray-800"> {{$employee->user->firstname}} {{$employee->user->lastname}}</span>
<span><a href="/client/companies/{{$company->id}}/employees/{{$employee->id}}/edit"><i class="fas fa-edit text-gray-800"></i></a></span>
